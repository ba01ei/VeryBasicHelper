#
#  Be sure to run `pod spec lint VeryBasicHelper.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "git@github.com:ba01ei/VeryBasicHelper.git", :tag => "1.0.1" }
  ...
  s.source_files  = "VeryBasicHelper/*.{swift}"
